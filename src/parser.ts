...
export async function parseChatRequest(
  ...
  if (!ai) {
    return {
      ...
      body: {
        success: false,
        error: "Could not extract full chat messages from this input, and Gemini API Key is missing for AI cleanup. Paste the visible chat transcript or configure an API key.",
      },
    };
  }
